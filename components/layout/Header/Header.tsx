            ...
            <div className="mx-auto px-11">
                ...
                <div className="flex items-center justify-between py-5 gap-8">
                    ...
                    <div className="flex items-center gap-4 shrink-0">
                        ...
                        <Link
                            href="/login"
                            className="flex items-center gap-2 px-5 py-2.5 border text-white rounded-xl font-bold border-(--primaryColor) bg-(--primaryColor) hover:bg-(--primaryColor) transition-all duration-300 shadow-md shadow-(--primaryColor)/10"
                        >
