...
export default function DiscountsComponent( { discountProducts } : { discountProducts : Product[] } ) {
    ...
    type FilterKey = 'categories' | 'brands' | 'price';

    const toggleFilter = (section: FilterKey) => {
        setOpenFilters(prev => ({
            ...prev,
                                ...
                                <div className="border-t border-gray-50 flex items-center justify-between pt-3 mt-4 px-1">
                                    <div className="flex flex-col gap-0.5">
                                        ...
                                        <span className="flex items-center gap-1 font-black text-[#D92F4E]">
                                            <span className='text-xl'>{product.discount.toLocaleString('Fa-ir')}</span>
